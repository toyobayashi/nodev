...
cd "./build/$os/$type"
echo "cmake -DBUILD_SHARED_LIBS=$dll -DCCPM_BUILD_TEST=$test -DCMAKE_BUILD_TYPE=$type -DCCPM_UNAME=$os ../../.."
cmake -DBUILD_SHARED_LIBS="$dll" -DCCPM_BUILD_TEST="$test" -DCMAKE_BUILD_TYPE=$type -DCCPM_UNAME=$os ../../..
cmake --build .
cd ../../..
